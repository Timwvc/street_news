...
<form action="topic.php" method="post" enctype="multipart/form-data" class="my-4" id="myform">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control validate[required]" name="topic_title" id="topic_title" placeholder="請輸入類別或主題名稱" value="{$topic.topic_title}">
    </div>
    <div class="form-group">
...
　               <option value="類別" selected="selected">類別</option>
    ...
    <div class="form-group">主題狀態:
        <input type="radio" id="topic_status1" name="topic_status" value="0" {if $topic.topic_status=='0' }checked{/if}>
        <label for="topic_status1">開始投稿</label>
        <input type="radio" id="topic_status2" name="topic_status" value="1" {if $topic.topic_status=='1' }checked{/if}>
        <label for="topic_status2">當期</label>
        <input type="radio" id="topic_status3" name="topic_status" value="2" {if $topic.topic_status=='2' }checked{/if}>
        <label for="topic_status3">一般</label>
        <input type="radio" id="topic_status4" name="topic_status" value="3" {if $topic.topic_status=='3' }checked{/if}>
